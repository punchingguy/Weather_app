...
def weather(request):
    if request.method == 'POST':
        url = 'http://dataservice.accuweather.com/locations/v1/cities/search?apikey=5Y17Xn2W90Al4ERIKs1mgchEyLqBYyvt&q={}'
        ...
        if list_of_data:
            ...
            weather_url = 'http://dataservice.accuweather.com/currentconditions/v1/' + location_data[
                "location_key"] + '?apikey=5Y17Xn2W90Al4ERIKs1mgchEyLqBYyvt&details=true'
            ...
            url = 'http://api.weatherapi.com/v1/forecast.json?key=98aaaaabffae487d94b140725211601&q={}&days=2'
